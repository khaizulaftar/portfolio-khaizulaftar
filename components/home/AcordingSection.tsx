        ...
        <>
            <div className="px-4 my-16 mb-24 max-w-screen-md mx-auto" id="FAQ">
                ...
                <motion.p
                    ...
                    className="max-w-lg mx-auto text-gray-500 text-center mt-6">Explore a collection of designs and custom that suit you, created by a web and Android developer</motion.p>
                <Accordion
                    type="single"
                    collapsible
