...
export default function ProjectSection() {
    ...
    return (
        <>
            <div className="my-16 px-4 max-w-screen-md mx-auto overflow-hidden" id="Projects">
                <motion.div
                ...
                <motion.p
                    ...
                    className="max-w-lg mx-auto text-gray-500 text-center mt-6">Build websites and applications that meet your needs and preferences</motion.p>
                <div className="mt-12 flex flex-col gap-8">
                    {
                        Data.map((v, i) => (
                            <motion.div
                                ...
                                <div className="shadow-xl relative w-full rounded-4xl overflow-hidden bg-white">
