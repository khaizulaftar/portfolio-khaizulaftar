    ...
    return (
        <>
            <div className="px-4 my-16 max-w-screen-md mx-auto" id="Skills">
                ...
                <BlurText
                    text="Powerful Technology and Skill Se"
                    delay={150}
                    animateBy="words"
                    direction="top"
                ...
                <motion.p
                    ...
                    className="max-w-lg mx-auto text-gray-500 text-center mt-6">Leveraging the latest technology and expertise in web and Android development to bring your ideas to life with excellent results</motion.p>
                <div className="mt-12">
                    {
                        skills.map((Skills) => (
                            <motion.div
